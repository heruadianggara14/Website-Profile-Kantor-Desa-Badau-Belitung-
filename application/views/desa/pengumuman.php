...
<head>
    ...
    <title>Pengumuman | Kantor Desa Badau</title>
</head>
        ...
        <div class="row">
            <div class="col-xl-9" style="background-color: #72D2CE">
                <div class="jumbotron mt-4">
                    <div class="container">
                        <!-- <center><img src="<?php echo base_url() ?> alt=""></center>
                               
                                    </div> -->
                        <center>
                            <div class="col-xl-10">
                                <h2 class="text-center">Pengumuman<br>
                                    Kantor Desa Badau
                                </h2>
                            ...
                            foreach ($pengumuman as $pts) : ?>
                                <tr>
                                    <center>
                                        <hr class="my-4">
                                        <br>
                                        <h1><?php echo $pts->judul; ?></h1>
                                        <br>
                                    </center>
                                    <p><img class="card-img-top" src="<?php echo base_url() . 'assets/foto_berita/' . $pts->foto ?>" width="200px" height="350px" alt="Card image cap"></p>
                        </center>

                        <p align="justify"><?php echo $pts->deskripsi; ?></p>
                        <br>
                        <br>
                        </tr>
