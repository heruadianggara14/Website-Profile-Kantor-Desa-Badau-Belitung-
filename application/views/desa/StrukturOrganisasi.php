...
<head>
    ...
    <title>Struktur Organisasi | Kantor Desa Badau</title>
</head>
                ...
                <div class="jumbotron mt-4">
                    <div class="">
                        ...
                        <figure class="effect-sadie">
                            <img src="<?php echo base_url() ?>assets_desa/img/ds.png" />
                        </figure>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xs-12 text-md-left mb-2 mt-2">
                        ...
                        <hr>
                        <p>SD Muhammadiyah Pandes &sdot; Where Tomorrow's Leaders Come Together</p>
                        <dl class="row">
                            <dt class="col-lg-4 col-md-4 col-sm-12"><span class="fa fa-map-marker"></span> Alamat</dt>
                            <dd class="col-lg-8 col-md-8 col-sm-12">Pandes I Wonokromo Pleret Bantul Yogyakarta Kode Pos 55791</dd>
                            <dt class="col-lg-4 col-md-4 col-sm-12"><span class="fa fa-phone"></span> Telepon</dt>
                            <dd class="col-lg-8 col-md-8 col-sm-12">0877 3935 3365</dd>
                            <dt class="col-lg-4 col-md-4 col-sm-12"><span class="fa fa-envelope"></span> Email</dt>
                            <dd class="col-lg-8 col-md-8 col-sm-12">muhammadiyah_sdpandes@yahoo.co.id</dd>
                        </dl>
                    </div>
                    <div class="col-md-4 col-xs-12 text-md-left mb-2 mt-2">
            ...
            <div class="container copyright">
                <div class="row pt-1 pb-1">
                    <div class="container text-center text-white">
                        Copyright &copy; 2019 SD Muhammadiyah Pandes All rights reserved. </div>
