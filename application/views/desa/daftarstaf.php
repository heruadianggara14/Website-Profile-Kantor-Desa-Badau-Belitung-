...
<head>
    ...
    <title>Daftar Staff | Kantor Desa Badau</title>
</head>
        ...
        <div class="row">
            <div class="col-xl-9" style="background-color: #72D2CE">
                <div class="jumbotron mt-4">
                    <div class="container">
                        <!-- <center><img src="<?php echo base_url() ?>assets_desa/img/kronologi.jpg" alt=""></center>
                                <center>
                                    <br>
                        ...
                        <center>
                            <div class="col-xl-10">
                                <h2 class="text-center">Daftar Staff Dan Anggota <br>
                                    Kantor Desa Badau
                                </h2>
                            </div>
                        </center>
