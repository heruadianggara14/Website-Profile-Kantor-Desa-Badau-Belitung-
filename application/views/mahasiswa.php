    	...
    	<table class="table">
    		...
    		foreach ($mahasiswa as $mhs) : ?>
    			<tr>
                    ...
                    <td onclick="javascript: return confirm('Anda Yakin Hapus ?')"l><?php echo anchor('mahasiswa/hapus/'.$mhs->id, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
